...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h3>Entry Container Trucking Cost Rate</h3>
            <hr>
                        ...
                        if ($check_detail > 0) {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php if($this->session->flashdata('failed_trucking_cost')) { ?>
                                        <div class="alert alert-warning">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <?php echo $this->session->flashdata('failed_trucking_cost'); ?>
                                        </div>
                                    <?php } ?>
                                 
                                    <?php if($this->session->flashdata('success_trucking_cost')) { ?>
                                        <div class="alert alert-success">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <?php echo $this->session->flashdata('success_trucking_cost'); ?>
                                        </div>
                                    <?php } ?>
