...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h3>Entry Container Custom Selling Rate</h3>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Form Container Custom Selling Rate
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($this->session->flashdata('failed_customs_selling')) { ?>
                                <div class="alert alert-warning">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('failed_customs_selling'); ?>
                                </div>
                            <?php } ?>
                         
                            <?php if($this->session->flashdata('success_customs_selling')) { ?>
                                <div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('success_customs_selling'); ?>
                                </div>
                            <?php } ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="custom_location_id" class="form-control">
                                        <option <?php echo set_select('custom_location_id', '', TRUE); ?> ></option>
                                        <?php  
                                            foreach ($custom_location as $key => $value) {?>
                                                <option value="<?php echo $value->GENERAL_ID; ?>" <?php echo set_select('custom_location_id', $value->GENERAL_ID, FALSE); ?> ><?php echo $value->GENERAL_DESCRIPTION; ?></option>
                                            <?php }
                                        ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Customs Kind</label>
                                    <select name="custom_kind_id" class="form-control">
                                        <option <?php echo set_select('custom_kind_id', '', TRUE); ?> ></option>
                                        <?php  
                                            foreach ($custom_kind as $key => $value) {?>
                                                <option value="<?php echo $value->GENERAL_ID; ?>" <?php echo set_select('custom_kind_id', $value->GENERAL_ID, FALSE); ?> ><?php echo $value->GENERAL_DESCRIPTION; ?></option>
                                            <?php }
                                        ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Customs Line</label>
                                    <select name="custom_line_id" class="form-control">
                                        <option <?php echo set_select('custom_line_id', '', TRUE); ?> ></option>
                                        <?php  
                                            foreach ($custom_line as $key => $value) {?>
                                                <option value="<?php echo $value->GENERAL_ID; ?>" <?php echo set_select('custom_line_id', $value->GENERAL_ID, FALSE); ?> ><?php echo $value->GENERAL_DESCRIPTION; ?></option>
                                            <?php }
                                        ?>
                                    </select>
                                </div>
