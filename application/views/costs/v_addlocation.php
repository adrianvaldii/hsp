...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h3>Entry Non Trailler Trucking Selling Rate</h3>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Form Non Trailler Trucking Selling Rate
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($this->session->flashdata('failed_entry_location_selling')) { ?>
                                <div class="alert alert-warning">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('failed_entry_location_selling'); ?>
                                </div>
                            <?php } ?>
                         
                            <?php if($this->session->flashdata('success_entry_location_selling')) { ?>
                                <div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('success_entry_location_selling'); ?>
                                </div>
                            <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="distance" class="form-control" value="<?php echo set_value('distance'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Distance in Litre</label>
                                                <input type="number" name="distance_per_litre" class="form-control" value="<?php echo set_value('distance_per_litre'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="truck_id">
                                            <option <?php echo set_select('truck_id', '', TRUE); ?> ></option>
                                            <?php  
                                                foreach ($truck_id as $key => $value) {?>
                                                    <option value="<?php echo $value->GENERAL_ID; ?>" <?php echo set_select('truck_id', $value->GENERAL_ID, FALSE); ?> ><?php echo $value->GENERAL_DESCRIPTION; ?></option>
                                                <?php }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tariff_amount" class="form-control" value="<?php echo set_value('tariff_amount'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
