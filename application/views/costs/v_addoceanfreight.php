...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h3>Add Ocean Freight Selling Rate</h3>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Form Ocean Freight Selling Rate
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($this->session->flashdata('failed_entry_ocean_selling')) { ?>
                                <div class="alert alert-warning">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('failed_entry_ocean_selling'); ?>
                                </div>
                            <?php } ?>
                         
                            <?php if($this->session->flashdata('success_entry_ocean_selling')) { ?>
                                <div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('success_entry_ocean_selling'); ?>
                                </div>
                            <?php } ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="charge_id" class="form-control">
                                            <option <?php echo set_select('charge_id', '', TRUE); ?>></option>
                                            <?php  
                                                foreach ($charges as $key => $value) {?>
                                                    <option value="<?php echo $value->GENERAL_ID; ?>" <?php echo set_select('charge_id', $value->GENERAL_ID, FALSE); ?>><?php echo $value->GENERAL_DESCRIPTION; ?></option>
                                                <?php }
                                            ?>
                                        </select>
                                    </div>
