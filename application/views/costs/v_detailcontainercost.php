                                                ...
                                                <?php 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <br>
                                                            <?php echo anchor_popup('Cost/edit_container_cost/'.$data->COMPANY_ID.'/'.$data->SELLING_SERVICE_ID.'/'.$data->COST_ID.'/'.'20'.'/'.$data->CONTAINER_TYPE_ID.'/'.$data->CONTAINER_CATEGORY_ID.'/'.$data->FROM_QTY.'/'.$data->TO_QTY.'/'.$data->FROM_LOCATION_ID.'/'.$data->TO_LOCATION_ID.'/'.$data->START_DATE.'/'.$data->END_DATE,'Edit Cost', $attributes); ?>
                                                        </td>
                                                ...
                                                <?php 
                                                   ...
                                                   <tr>
                                                        <td>
                                                            <?php echo $data->COST_NAME; ?>
                                                            <br>
                                                            <?php echo anchor_popup('Cost/edit_container_cost/'.$data->COMPANY_ID.'/'.$data->SELLING_SERVICE_ID.'/'.$data->COST_ID.'/'.'40'.'/'.$data->CONTAINER_TYPE_ID.'/'.$data->CONTAINER_CATEGORY_ID.'/'.$data->FROM_QTY.'/'.$data->TO_QTY.'/'.$data->FROM_LOCATION_ID.'/'.$data->TO_LOCATION_ID.'/'.$data->START_DATE.'/'.$data->END_DATE,'Edit Cost', $attributes); ?>
                                                        </td>
                                                        <td><?php echo $data->COST_TYPE; ?></td>
                                                        <td><?php echo $data->COST_GROUP; ?></td>
                                                        <td><?php echo $data->FROM_QTY; ?></td>
                                                ...
                                                <?php 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo $data->COST_NAME; ?>
                                                            <br>
                                                            <?php echo anchor_popup('Cost/edit_container_cost/'.$data->COMPANY_ID.'/'.$data->SELLING_SERVICE_ID.'/'.$data->COST_ID.'/'.'4H'.'/'.$data->CONTAINER_TYPE_ID.'/'.$data->CONTAINER_CATEGORY_ID.'/'.$data->FROM_QTY.'/'.$data->TO_QTY.'/'.$data->FROM_LOCATION_ID.'/'.$data->TO_LOCATION_ID.'/'.$data->START_DATE.'/'.$data->END_DATE,'Edit Cost', $attributes); ?>
                                                        </td>
                                                        <td><?php echo $data->COST_TYPE; ?></td>
                                                        <td><?php echo $data->COST_GROUP; ?></td>
                                                        <td><?php echo $data->FROM_QTY; ?></td>
                                                ...
                                                <?php 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo $data->COST_NAME; ?>
                                                            <br>
                                                            <?php echo anchor_popup('Cost/edit_container_cost/'.$data->COMPANY_ID.'/'.$data->SELLING_SERVICE_ID.'/'.$data->COST_ID.'/'.'45'.'/'.$data->CONTAINER_TYPE_ID.'/'.$data->CONTAINER_CATEGORY_ID.'/'.$data->FROM_QTY.'/'.$data->TO_QTY.'/'.$data->FROM_LOCATION_ID.'/'.$data->TO_LOCATION_ID.'/'.$data->START_DATE.'/'.$data->END_DATE,'Edit Cost', $attributes); ?>
                                                        </td>
                                                        <td><?php echo $data->COST_TYPE; ?></td>
                                                        <td><?php echo $data->COST_GROUP; ?></td>
                                                        <td><?php echo $data->FROM_QTY; ?></td>
