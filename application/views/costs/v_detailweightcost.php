                                    ...
                                    <?php  
                                        foreach ($details as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 0 20px;">:</td>
                                                <td><?php echo $value->FROM_WEIGHT . " - " . $value->TO_WEIGHT . " MT"; ?></td>
                                            </tr>
                                            <?php
                                        }
                                    ?>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <?php echo anchor_popup('Cost/edit_weight_cost/'.$data->COMPANY_SERVICE_ID.'/'.$data->SELLING_SERVICE_ID.'/'.$data->COST_ID.'/'.$data->FROM_LOCATION_ID.'/'.$data->TO_LOCATION_ID.'/'.$data->FROM_WEIGHT.'/'.$data->TO_WEIGHT.'/'.$data->START_DATE.'/'.$data->END_DATE.'/'.$data->INCREMENT_QTY,'Edit Cost', $attributes); ?>
                                        </td>
                                        <td><?php echo $data->COST_TYPE; ?></td>
                                        <td><?php echo $data->COST_GROUP; ?></td>
                                        <td><?php echo $data->START_DATE; ?></td>
                                        <td><?php echo $data->END_DATE; ?></td>
                                        <td><?php echo $data->FROM_WEIGHT; ?></td>
                                        <td><?php echo $data->TO_WEIGHT; ?></td>
