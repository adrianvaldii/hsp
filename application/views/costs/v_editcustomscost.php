                    ...
                    <table>
                        <?php  
                            foreach ($details as $key => $value) {
                                ...
                                <tr>
                                    <td><strong>Custom Kind</strong></td>
                                    <td style="padding: 0 20px;">:</td>
                                    <td class="text-capitalize"><?php echo $value->CUSTOM_KIND; ?></td>
                                </tr>
                                <?php
                            }
                        ?>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($this->session->flashdata('failed_edit_customs_cost')) { ?>
                                <div class="alert alert-warning">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('failed_edit_customs_cost'); ?>
                                </div>
                            <?php } ?>
                         
                            <?php if($this->session->flashdata('success_edit_customs_cost')) { ?>
                                <div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('success_edit_customs_cost'); ?>
                                </div>
                            <?php } ?>
