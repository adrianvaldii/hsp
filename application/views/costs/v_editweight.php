...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h3>Edit Service Bulk Selling Rate</h3>
            <hr>
            <div class="row">
                <div class="col-md-6">
                    <table>
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Form Edit Service Bulk Selling Rate
                </div>
                <div class="panel-body">
                   <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($this->session->flashdata('failed_edit_weight_selling')) { ?>
                                <div class="alert alert-warning">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('failed_edit_weight_selling'); ?>
                                </div>
                            ...
                            <?php if($this->session->flashdata('success_edit_weight_selling')) { ?>
                                <div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <?php echo $this->session->flashdata('success_edit_weight_selling'); ?>
                                </div>
                                <script type="text/javascript">
                                    setTimeout(function() {
                                        window.close();
