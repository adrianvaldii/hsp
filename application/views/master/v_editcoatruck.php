...
<div class="container-fluid font_mini">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h1>Edit GL Account Truck <a href="<?php echo site_url('Master/view_coa_truck'); ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Back</a></h1>
            <hr>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <?php echo form_open(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" readonly="true" name="truck_id" id="truck_id">
                                        <option></option>
                                        <?php
                                            foreach ($data_truck as $key => $value) {
                                                ?>
                                                    <option <?php if ($truck_id == $value->TRUCK_ID) echo 'selected' ?> value="<?php echo $value->TRUCK_ID ?>"><?php echo $value->TRUCK_ID; ?></option>
                                                <?php
                                            }
                                        ?>
                                    </select>
