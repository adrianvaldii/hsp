                        ...
                        <?php } ?>
                            ...
                            <?php echo form_open(); ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="truck_id" class="form-control" value="<?php echo set_value('truck_id'); ?>" placeholder="e.g. B 9090 HSP" />
                                </div>
                                <div class="form-group">
                                    <label>Company</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="stnk_expired" class="form-control date" value="<?php echo set_value('stnk_expired'); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>BPKB Number</label>
                                            <input type="number" name="bpkb_number" class="form-control" value="<?php echo set_value('bpkb_number'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
