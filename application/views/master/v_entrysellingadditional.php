...
<div class="container-fluid font_mini">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h3>Entry Selling Service Additional Rate</h3>
            <hr>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="panel-body">
                            <?php echo form_open(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single js-states" name="selling_service_id" id="selling_service_id">
                                        <option <?php echo set_select('selling_service_id', '', TRUE); ?> ></option>
                                        <?php 
                                            foreach ($services as $key => $value) {
                                                ?>
                                                    <option value="<?php echo $value->SELLING_SERVICE_ID; ?>" <?php echo set_select('selling_service_id', $value->SELLING_SERVICE_ID, FALSE); ?> ><?php echo $value->SERVICE_NAME; ?></option>
                                                <?php
                                            }
                                        ?>
                                    </select>
