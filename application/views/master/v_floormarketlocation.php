...
<div class="container-fluid"> 
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h4>Floor and Marketplace Price Non Trailler Trucking</h4>
            <hr>
        </div>
    </div>
    <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if($this->session->flashdata('failed_floor_location')) { ?>
                            <div class="alert alert-warning">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <?php echo $this->session->flashdata('failed_floor_location'); ?>
                            </div>
                        <?php } ?>
                        
                        <?php if($this->session->flashdata('success_floor_location')) { ?>
                            <div class="alert alert-success">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <?php echo $this->session->flashdata('success_floor_location'); ?>
                            </div>
                        <?php } ?>
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="hidden" name="truck_id[]" value="<?php echo $value['TRUCK_ID']; ?>">
                                                </td>
