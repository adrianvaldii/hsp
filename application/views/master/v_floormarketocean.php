...
<div class="container-fluid"> 
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h4>Floor and Marketplace Price Freight</h4>
            <hr>
        </div>
    </div>
    <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if($this->session->flashdata('failed_floor_ocean')) { ?>
                            <div class="alert alert-warning">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <?php echo $this->session->flashdata('failed_floor_ocean'); ?>
                            </div>
                        <?php } ?>
                        
                        <?php if($this->session->flashdata('success_floor_ocean')) { ?>
                            <div class="alert alert-success">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <?php echo $this->session->flashdata('success_floor_ocean'); ?>
                            </div>
                        <?php } ?>
                        ...
                        <table class="table table-striped table-bordered display" id="tabel-trucking" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                    foreach ($result_ocean as $key => $value) {
                                        ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <!-- input hidden -->
                                                    <input type="hidden" name="company_service[]" value="<?php echo $value['COMPANY_SERVICE_ID']; ?>">
                                                    <input type="hidden" name="selling_service[]" value="<?php echo $value['SELLING_SERVICE_ID']; ?>">
                                                    <input type="hidden" name="from_location[]" value="<?php echo $value['FROM_LOCATION_ID']; ?>">
                                                    <input type="hidden" name="to_location[]" value="<?php echo $value['TO_LOCATION_ID']; ?>">
                                                    <input type="hidden" name="charge_id[]" value="<?php echo $value['CHARGE_ID']; ?>">
