            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if($this->session->flashdata('failed_floor_weight')) { ?>
                            <div class="alert alert-warning">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <?php echo $this->session->flashdata('failed_floor_weight'); ?>
                            </div>
                        <?php } ?>
                        
                        <?php if($this->session->flashdata('success_floor_weight')) { ?>
                            <div class="alert alert-success">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <?php echo $this->session->flashdata('success_floor_weight'); ?>
                            </div>
                        <?php } ?>
                        ...
                        <table class="table table-striped table-bordered display" id="tabel-trucking" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                    foreach ($result_weight as $key => $value) {
                                        ?>
                                            <tr>
                                                <td>
