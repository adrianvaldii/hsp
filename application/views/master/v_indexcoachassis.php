        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <table class="table table-striped table-bordered" id="table-service">
                ...
                <tbody>
                    <?php 
                    $no = 1;
                    foreach($data_coa_chassis as $key => $value){
                    // $truck_re = str_replace(" ", "_", $value->TRUCK_ID); 
                    ?>
                    <tr>
                        <td class="text-center"><?php echo $no++; ?></td>
                        <td class="text-center"><?php echo $value->CHASSIS_ID; ?></td>
                        <td class="text-left"><?php echo $value->COST_NAME; ?></td>
                        <td class="text-center"><?php echo $value->ACCOUNT_CODE; ?></td>
                        <td class="text-center"><?php echo anchor('Master/edit_coa_chassis/'.$value->CHASSIS_ID.'/'.$value->COST_ID, 'Edit', array('class' => 'text-center')); ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
