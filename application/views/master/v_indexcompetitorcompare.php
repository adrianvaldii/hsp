            ...
            <table class="table table-striped table-bordered" id="table-service">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Compare ID</th>
                ...
                <tbody>
                    <?php 
                    $no = 1;
                    foreach($competitor_compare as $key => $value){
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo anchor('Master/edit_competitor_compare/'.$value->COMPARE_ID, 'Edit', array('class' => 'text-center')); ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
