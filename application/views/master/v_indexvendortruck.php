        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered" id="table-service">
                ...
                <tbody>
                    <?php 
                    $no = 1;
                    foreach($data_vendor_truck as $key => $value){ 
                    ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo anchor('Master/edit_vendor_truck/'.$value->CONTRACT_NO.'/'.$value->COMPANY_ID.'/'.$value->CONTAINER_SIZE_ID.'/'.$value->CONTAINER_TYPE_ID.'/'.$value->CONTAINER_CATEGORY_ID.'/'.$value->FROM_QTY.'/'.$value->TO_QTY.'/'.$value->FROM_LOCATION_ID.'/'.$value->TO_LOCATION_ID, 'Edit', array('class' => 'text-center')); ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
