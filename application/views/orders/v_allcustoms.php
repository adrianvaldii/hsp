...
<div class="container-fluid font_mini">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h3>Work Order Customs Clearance</h3>
            <hr>
        </div>
    </div>
    <div class="row">
                        ...
                        foreach ($data_wo as $key => $value) {
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $value->REGISTER_NUMBER_PIB_PEB; ?></td>
                                    <td class="text-center"><?php echo anchor('Order/entry_customs/'.$value->WORK_ORDER_NUMBER, 'Edit', array('class' => 'text-center')); ?></td>
                                </tr>
                            <?php
                            $no++;
                        }
