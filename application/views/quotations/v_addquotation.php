...
<div class="container-fluid font_mini">
    ...
    <?php echo form_open('Quotation/add_quotation', $attr_form); ?>
    	<div class="panel panel-default">
    		...
    		<div class="panel-body">
                ...
                <?php if(isset($quotation_error) && $quotation_error == "error") { ?>
                    <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo "Quotation number already exists!" ?>
                    </div>
                <?php } ?>
				    			...
				    			<div class="panel panel-default">
				    				...
				    				<div class="panel-body">
				    					<div class="row">
				    						<div class="col-md-12">
				    							<div class="form-group">
								    				...
								    				<input type="hidden" name="quotation_number" class="form-control" value="<?php echo $id; ?>">
								    			</div>
				    						</div>
				    					</div>
				    					<div class="row">
				    						<div class="col-md-6">
				    							<div class="form-group">
								    				...
								    				<input type="text" name="company_name" class="form-control" id="company" value="<?php echo set_value('company_name'); ?>">

								    				<!-- hidden -->
								    				<input type="hidden" name="company_id" value="<?php echo set_value('company_id'); ?>">
								    			</div>	
				    						</div>
				    						<div class="col-md-6">
								    			<div class="form-group">
								    				<label>Sales<span style="color:red">*</span></label>
								    				<input type="text" name="sales_name" id="sales_name" class="form-control" value="<?php echo set_value('sales_name'); ?>">
								    				<input type="hidden" name="sales_id" class="form-control" value="<?php echo set_value('sales_id'); ?>">
								    			</div>
				    						</div>
				    					</div>
				    					<div class="row">
				    						<div class="col-md-6">
				    							<div class="form-group">
								    				...
								    				<input type="text" name="pic_name" class="form-control" value="<?php echo set_value('pic_name'); ?>" readonly="true">

								    				<!-- hidden -->
								    				<input type="hidden" name="pic_id" value="<?php echo set_value('pic_id'); ?>">
								    			</div>	
				    						</div>
				    						<div class="col-md-6">
								    			<div class="form-group">
								    				<label>Remarks</label>
								    				<textarea name="remarks" class="form-control" style="text-align:left;"></textarea>
								    			</div>	
				    						</div>
				    					</div>
				    					<div class="row">
				    						<div class="col-md-6">
				    							<div class="form-group">
								    				...
								    				<input type="text" name="start_date" class="form-control" value="<?php echo date('Y-m-d'); ?>" id="start_date">
								    			</div>
				    						</div>
				    						<div class="col-md-6">
				    							<div class="form-group">
						    			...
						    			<div class="form-group">
						    				...
						    				<div class="checkbox">
											  <label>
											    <input type="checkbox" name="service[]" value="trucking" id="service-trucking" <?php echo set_checkbox('service[]', 'trucking'); ?> />
											    Trailer Trucking
											  </label>
											</div>
											<div class="checkbox">
											  <label>
											    <input type="checkbox" name="service[]" value="customs" id="service-customs" <?php echo set_checkbox('service[]', 'customs'); ?> />
											    Container Custom Clearance
											  </label>
											</div>
											<div class="checkbox">
											  <label>
											    <input type="checkbox" name="service[]" value="location" id="service-location" <?php echo set_checkbox('service[]', 'location'); ?> />
											    Non Trailer Trucking
											  </label>
											</div>
											<div class="checkbox">
											  <label>
											    <input type="checkbox" name="service[]" value="weight" id="service-weight" <?php echo set_checkbox('service[]', 'weight'); ?> />
											    Weight Measurement Trucking
											  </label>
											</div>
											<div class="checkbox">
											  <label>
											    <input type="checkbox" name="service[]" value="ocean" id="service-ocean" <?php echo set_checkbox('service[]', 'ocean'); ?> />
											    Freight
											  </label>
											</div>
											<!-- <div class="checkbox">
												        				...
												        				?>
												        					...
												        					<input type="hidden" name="temp_to_name<?php echo $loop_code; ?>" value="<?php echo $value->TO_NAME; ?>">
															        			...
															        			<?php
															        				if ($value->TOTAL > 0) {
															        					?>
															        						<td class="fit" style="text-align: center;"><button class="addRow addclick btn btn-primary" id="clickTrucking<?php echo $loop_code; ?>" onClick="return addTrucking('<?php echo $loop_code; ?>')">Add</button></td>
															        					<?php
															        				} else {
															        					?>
															        						<td class="fit" style="text-align: center;">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        $("#sales_name").autocomplete({
          source: "<?php echo site_url('Order/search_nik'); ?>",
          minLength:1,
          select:function(event, data){
            $('input[name=sales_id]').val(data.item.pic_id);
          }
        });
	...
	function addTrucking(id)
	{
    	...
    	var company = document.forms['quotation'].elements['temp_company'+id].value

    	// // append data
    	// $('#tableTrucking').append('<tr id="baris'+id+'"><input type="hidden" name="trucking['+no_trucking+'][selling_service]" value="'+selling_service+'"><input type="hidden" name="trucking['+no_trucking+'][size]" value="'+size+'"><input type="hidden" name="trucking['+no_trucking+'][type]" value="'+type+'"><input type="hidden" name="trucking['+no_trucking+'][category]" value="'+category+'"><input type="hidden" name="trucking['+no_trucking+'][from]" value="'+from+'"><input type="hidden" name="trucking['+no_trucking+'][to]" value="'+to+'"><input type="hidden" name="trucking['+no_trucking+'][currency]" value="'+currency+'"><input type="hidden" name="trucking['+no_trucking+'][amount]" value="'+amount+'"><input type="hidden" name="trucking['+no_trucking+'][from_qty]" value="'+from_qty+'"><input type="hidden" name="trucking['+no_trucking+'][to_qty]" value="'+to_qty+'"><input type="hidden" name="trucking['+no_trucking+'][calc]" value="'+calc+'"><input type="hidden" name="trucking['+no_trucking+'][increment]" value="'+increment+'"><input type="hidden" name="trucking['+no_trucking+'][start_date]" value="'+start+'"><input type="hidden" name="trucking['+no_trucking+'][end_date]" value="'+end+'"><td>'+from_name+'</td><td>'+to_name+'</td><td>'+size+" - "+type+" - "+category+'</td><td>'+toRp(amount)+'</td><td><input type="text"  name="trucking['+no_trucking+'][offer_price]" style="text-align: center;" value="'+amount+'"></td><td class="fit" style="text-align: center;"><a class="btn_remove addclick" id="'+id+'">Remove</a> | <a href="http://192.168.11.31/hsp/Quotation/cost_detail_trucking/" onclick="window.open(\'http://192.168.11.31/hsp/Quotation/cost_detail_trucking/'+selling_service+'/'+type+'/'+category+'/'+from+'/'+to+'/'+size+'\', \'_blank\', \'width=1000,height=620,scrollbars=yes,menubar=no,status=yes,resizable=yes,screenx=\'+((parseInt(screen.width) - 950)/2)+\',screeny=\'+((parseInt(screen.height) - 700)/2)+\'\'); return false;">Cost Detail</a></td></tr>');

    	// append data
        $('#tableTrucking').append('<tr id="baris'+id+'"><input type="hidden" name="trucking['+no_trucking+'][selling_service]" value="'+selling_service+'"><input type="hidden" name="trucking['+no_trucking+'][size]" value="'+size+'"><input type="hidden" name="trucking['+no_trucking+'][type]" value="'+type+'"><input type="hidden" name="trucking['+no_trucking+'][category]" value="'+category+'"><input type="hidden" name="trucking['+no_trucking+'][from]" value="'+from+'"><input type="hidden" name="trucking['+no_trucking+'][to]" value="'+to+'"><input type="hidden" name="trucking['+no_trucking+'][currency]" value="'+currency+'"><input type="hidden" name="trucking['+no_trucking+'][amount]" value="'+amount+'"><input type="hidden" name="trucking['+no_trucking+'][from_qty]" value="'+from_qty+'"><input type="hidden" name="trucking['+no_trucking+'][to_qty]" value="'+to_qty+'"><input type="hidden" name="trucking['+no_trucking+'][calc]" value="'+calc+'"><input type="hidden" name="trucking['+no_trucking+'][increment]" value="'+increment+'"><input type="hidden" name="trucking['+no_trucking+'][start_date]" value="'+start+'"><input type="hidden" name="trucking['+no_trucking+'][end_date]" value="'+end+'"><input type="hidden" name="trucking['+no_trucking+'][company_id]" value="'+company+'"><td>'+from_name+'</td><td>'+to_name+'</td><td>'+size+" - "+type+" - "+category+'</td><td>'+toRp(amount)+'</td><td><input type="number" pattern="(\d{3})" name="trucking['+no_trucking+'][offer_price]" style="text-align: center;" value="'+amount+'"></td><td class="fit" style="text-align: center;"><a class="btn_remove addclick" id="'+id+'">Remove</a> | <a href="<?php echo site_url('Quotation/cost_detail_trucking'); ?>" onclick="window.open(\'<?php echo site_url('Quotation/cost_detail_trucking/'); ?>'+selling_service+'/'+type+'/'+category+'/'+from+'/'+to+'/'+size+'/'+company+'\', \'_blank\', \'width=1000,height=620,scrollbars=yes,menubar=no,status=yes,resizable=yes,screenx=\'+((parseInt(screen.width) - 950)/2)+\',screeny=\'+((parseInt(screen.height) - 700)/2)+\'\'); return false;">Cost Detail</a></td></tr>');
	...
	function addCustoms(id)
	{
    	...
    	var company = document.forms['quotation'].elements['temp_customs_company'+id].value

    	// append data
    	$('#tableCustoms').append('<tr id="baris'+id+'"><input type="hidden" name="customs['+no+'][selling_customs]" value="'+selling_service+'"><input type="hidden" name="customs['+no+'][size_customs]" value="'+size+'"><input type="hidden" name="customs['+no+'][type_customs]" value="'+type+'"><input type="hidden" name="customs['+no+'][line_customs]" value="'+line+'"><input type="hidden" name="customs['+no+'][kind_customs]" value="'+kind+'"><input type="hidden" name="customs['+no+'][category_customs]" value="'+category+'"><input type="hidden" name="customs['+no+'][from_customs]" value="'+from+'"><input type="hidden" name="customs['+no+'][currency_customs]" value="'+currency+'"><input type="hidden" name="customs['+no+'][amount_customs]" value="'+amount+'"><input type="hidden" name="customs['+no+'][from_qty_customs]" value="'+from_qty+'"><input type="hidden" name="customs['+no+'][to_qty_customs]" value="'+to_qty+'"><input type="hidden" name="customs['+no+'][calc_customs]" value="'+calc+'"><input type="hidden" name="customs['+no+'][increment_customs]" value="'+increment+'"><input type="hidden" name="customs['+no+'][start_customs]" value="'+start+'"><input type="hidden" name="customs['+no+'][end_customs]" value="'+end+'"><input type="hidden" name="customs['+no+'][company_id]" value="'+company+'"><td style="text-align: center;">'+from+'</td><td style="text-align: center;">'+size+" - "+type+" - "+line+" - "+kind+'</td><td style="text-align: center;">'+category+'</td><td style="text-align: center;">'+from_qty+ " - "+to_qty+'</td><td style="text-align: right;">'+toRp(amount)+'</td><td style="text-align: center;"><input type="number" name="customs['+no+'][offer_customs]" style="text-align: center;" value="'+amount+'"></td><td class="fit" style="text-align: center;"><a class="btn_remove addclick" id="'+id+'">Remove</a> | <a href="<?php echo site_url('Quotation/cost_detail_customs'); ?>" onclick="window.open(\'<?php echo site_url('Quotation/cost_detail_customs/'); ?>'+selling_service+'/'+type+'/'+category+'/'+size+'/'+from+'/'+line+'/'+kind+'/'+company+'\', \'_blank\', \'width=1000,height=620,scrollbars=yes,menubar=no,status=yes,resizable=yes,screenx=\'+((parseInt(screen.width) - 950)/2)+\',screeny=\'+((parseInt(screen.height) - 700)/2)+\'\'); return false;">Cost Detail</a></td></tr>');
