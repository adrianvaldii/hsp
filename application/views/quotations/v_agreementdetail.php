                    ...
                    <div class="row" style="margin-left: 35px;">
                        <div class="col-md-6">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <?php 
                                            ...
                                            //     echo anchor('Quotation/print_agreement/'.$agreement_number.'/'.$quotation_number, 'Print', array('title' => 'Print Agreement', 'class' => 'btn btn-success'));
                                            // } else {
                                            //     echo '<button class="btn btn-success" type="button" disabled>Print</button>';
                                            // }
                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?php echo form_open('Quotation/print_agreement/'.$agreement_number.'/'.$quotation_number); ?>
                                            ...
                                            <div class="col-md-6">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><strong>Quotation Number</strong></td>
                                                        <td style="padding: 0 10px;">:</td>
                                                        <td class="text-capitalize"> <?php echo $quotation_number; ?> </td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Document Number</strong></td>
                                                        <td style="padding: 10px 10px;">:</td>
