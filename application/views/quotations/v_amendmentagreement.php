...
<div class="container-fluid font_mini">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h3>Amendment Agreement</h3>
            <hr>
        </div>
    </div>
    <?php echo form_open('Quotation/amendment_agreement/'.$agreement_number.'/'.$quotation_number, $attr_form); ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php if(isset($truck_error) && $truck_error == "error") { ?>
                    ...
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo "Data trucking not valid. Please check data before amendment!"; ?>
                    </div>
                <?php } ?>
                ...
                <?php if(isset($customs_error) && $customs_error == "error") { ?>
                    <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo "Data Customs Clearance not valid. Please check data before amendment!"; ?>
                    </div>
                <?php } ?>
                ...
                <?php if(isset($location_error) && $location_error == "error") { ?>
                    <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo "Data Non Trailler not valid. Please check data before amendment!"; ?>
                    </div>
                <?php } ?>
                ...
                <?php if(isset($weight_error) && $weight_error == "error") { ?>
                    <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo "Data Weight Measurement not valid. Please check data before amendment!"; ?>
                    </div>
                <?php } ?>
                ...
                <?php if($this->session->flashdata('failed_amendment')) { ?>
                    <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo $this->session->flashdata('failed_amendment'); ?>
                    </div>
                <?php } ?>
                
                <?php if($this->session->flashdata('success_amendment')) { ?>
                    <div class="alert alert-success">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <?php echo $this->session->flashdata('success_amendment'); ?>
                    </div>
                <?php } ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="agreement_document_number" class="form-control" value="<?php echo $document_number; ?>" readonly="true">
                                                    <input type="hidden" name="quotation_number" class="form-control" value="<?php echo $quotation_number; ?>">
                                                    <input type="hidden" name="agreement_number" class="form-control" value="<?php echo $agreement_number; ?>">

                                                    <!-- quotation -->
                                                    <input type="hidden" name="company_name" class="form-control" id="company" readonly="true" value="<?php echo $customer_name_revision; ?>">
                                                    <input type="hidden" name="company_id" value="<?php echo $customer_id_revision; ?>">
                                                    <input type="hidden" name="sales_id" class="form-control" value="<?php echo $marketing_id; ?>">
                                                    <textarea name="remarks" class="form-control" style="text-align:left; display:none;">
                                                        <?php echo $remarks; ?>
                                                    </textarea>
                                                    <input type="hidden" name="start_date" class="form-control" value="<?php echo $start_date_revision; ?>" id="start_date">
                                                    <input type="hidden" name="end_date" class="form-control" id="end_date" value="<?php echo $end_date_revision; ?>">
                                                    <textarea class="form-control" name="template_text1" id="text-indonesia" style="display:none;">
                                                        <?php echo $template_text1; ?>
                                                    </textarea>
                                                    <textarea class="form-control" name="template_text2" id="text-inggris"  style="display:none;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="start_date_agreement" class="form-control" value="<?php echo $start_date_agreement; ?>" id="start_date">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>End Date<span style="color:red">*</span></label>
                                                    <input type="text" name="end_date_agreement" class="form-control" id="end_date" value="<?php echo $end_date_agreement; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
