                            ...
                            <div class="col-md-5">
                                <table>
                                    <tr>
                                        ...
                                        <td><span class="text-capitalize"><?php echo $details->COMPANY_NAME; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Service Name</strong></td>
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->SERVICE_NAME; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Floor Price</strong></td>
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo currency($floor_price); ?></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-4">
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->CUSTOM_LOCATION; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Custom Line</strong></td>
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->CUSTOM_LINE; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Market Price</strong></td>
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo currency($market_price); ?></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-3">
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->CONTAINER_TYPE; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Container Category</strong></td>
                                        <td style="padding: 20px 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->CONTAINER_CATEGORY; ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
