                            ...
                            <div class="col-md-6">
                                <table>
                                    <tr>
                                        ...
                                        <td class="text-capitalize"><?php echo $details->COMPANY_NAME; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 0 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->FROM_NAME; ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-md-6">
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding: 0 20px;">:</td>
                                        <td class="text-capitalize"><?php echo $details->TO_NAME; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Weight</strong></td>
                                        <td style="padding: 20px 20px;">:</td>
                                        <td><?php echo $details->FROM_WEIGHT . " - " . $details->TO_WEIGHT . " MT"; ?></td>
                                    </tr>
                                    <tr>
