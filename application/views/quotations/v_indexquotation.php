						...
						foreach ($data_quotation as $value) {
							?>
								<tr>
									...
									<td style="text-align:center">
										<?php 
											if ($value->APPROVAL_STATUS != 'R') {
												if ($value->STATUS_AGREEMENT == 0) {
													echo anchor('Quotation/revision_quotation/'.$value->QUOTATION_NUMBER, 'Revision', array('class' => 'text-center'));
												} else {
													echo "Revision";
												}
											} else {
									...
									<td style="text-align:center">
										<?php 
											echo anchor('Quotation/detail_quotation/'.$value->QUOTATION_NUMBER, 'Detail', array('class' => 'text-center'));
										?>
									</td>
								</tr>
							<?php
