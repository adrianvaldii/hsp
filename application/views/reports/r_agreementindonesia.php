...
<body>
	<div class="container format-print">
		...
		<div class="main">
			<div class="row">
				<div class="col-xs-12">
					...
					<p>Terlampir kami sampaikan persetujuan yang telah disepakati sebelumnya (IDR) sebagai berikut:</p>
					<?php
						if ($count_customs > 0) {
							?>
		...
		<div class="row">
			<div class="col-xs-12">
				<p>Demikian persetujuan ini kami sampaikan, sebagai tanda persetujuan mohon ditanda tangan dibawah ini kemudian dikembalikan kepada kami via email atau fax.</p>
