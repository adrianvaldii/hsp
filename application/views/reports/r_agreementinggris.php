	...
	<div class="container format-print">
		<div class="row">
			<div class="col-xs-12 detail-ref">
				<h6 class="ref-no">Ref. No : <?php echo $agreement_document_number; ?></h6>
				<h6 class="tanggal">Jakarta, <?php echo $agreement_date; ?></h6>
			</div>
		</div>
		<br>
		<div class="main">
			<div class="row">
				<div class="col-xs-12">
					...
					<br>
					<p class="text-capitalize">Dear <?php echo $pic_namdep . " " . $pic_name; ?>,</p>
					<p>Please kindly find our proposal for services agreed as follows in IDR unless otherwise stated:</p>
					<?php
						if ($count_customs > 0) {
							?>
					...
					<?php
						if ($count_trucking > 0) {
							?>
								- &emsp; FCL Trucking Charges from Tanjung Priok :
								<br>
								<br>
								<table class="table table-bordered">
									<thead>
					...
					<?php
						if ($count_weight > 0) {
							?>
								- &emsp; Break Bulk (LCL) from Tanjung Priok :
								<br>
								<br>
								<table class="table table-bordered">
									<thead>
		...
		<div class="row">
			<div class="col-xs-12">
				<p>Kindly sign below as acceptance of our agreement and terms and return to us via email or fax.</p>
				<p>Please feel free to contact us if you have any further questions. Thank you for your attention and we look forward to working with you.</p>
			</div>
		</div>
		<br>
		<div class="row">
