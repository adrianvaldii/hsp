...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12">
				<p>CUSTOMS SELLING PT. HANOMAN SAKTI PRATAMA</p>
			</div>
		</div>
		<div class="row">
				...
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th rowspan="2" style="text-align: center;">From Qty</th>
							<th rowspan="2" style="text-align: center;">To Qty</th>
						...
						<?php 
							...
							foreach ($hasil_custom_jakarta as $key => $data) { ?>
								<tr>
		                            ...
		                            <td style="text-align: center;"><?php echo $data['FROM_QTY']; ?></td>
		                            <td style="text-align: center;"><?php echo $data['TO_QTY']; ?></td>
