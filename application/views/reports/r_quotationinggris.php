...
<body>
	<div class="container format-print">
		...
		<div class="main">
			<div class="row">
				<div class="col-xs-12">
					...
					<p>Please kindly find our proposal for services offered as follows in IDR unless otherwise stated:</p>
					<?php
						if ($count_customs > 0) {
							?>
		...
		<div class="row">
			<div class="col-xs-12">
				<p>Kindly sign below as acceptance of our proposal and terms and return to us via email or fax.</p>
